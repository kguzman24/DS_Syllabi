...
row.names(top_k_df) <- c("ASU", "BostonU", "Brown", 
                          "Cornell", "CUNY", "Drexel", 
                          "GeorgiaTech", "Harvard", "LSU", 
                          "MIT", "MontgomeryColl", "NYUDS4E", 
                          "NYUIntroDS", "Princeton", "Rutgers",
                          "UCBerkeley", "UCSanDiego", "UIU107",
                          "UIU207", "UKentucky", "UMaine",
                          "UMD", "UniSystemGeorgia", "USouthampton",
                          "UToronto", "UUtah", "UWashington",
                          "UWiscMadisonModeling", "UWiscMadisonProgramming", 
                          "UWisconsin", "UZurich", "WashingtonState", "WandM")
top_k_df
```

Next, we create a horizontal bar chart for each with the top k words
```{r}
